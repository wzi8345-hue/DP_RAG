...
def list_skills(_auth: str = Depends(require_auth)) -> SkillListResponse:
...
def save_skill(spec: SkillSpec, _auth: str = Depends(require_auth)) -> SkillSaveResponse:
...
def remove_skill(skill_id: str, _auth: str = Depends(require_auth)) -> SkillDeleteResponse:
